...
\restrict sH0cb40zo3DwslWBymlecwEUAWMXKtfGO56fVKbCwb7KIAvSkBNqzwFdZ9ZkVwN
...
ALTER FUNCTION public.set_user_password(new_password text) OWNER TO postgres;
...
GRANT ALL ON FUNCTION public.set_user_password(new_password text) TO anon;
GRANT ALL ON FUNCTION public.set_user_password(new_password text) TO authenticated;
GRANT ALL ON FUNCTION public.set_user_password(new_password text) TO service_role;
...
GRANT ALL ON TABLE public.apartment_meters TO PUBLIC;
...
GRANT ALL ON TABLE public.properties TO PUBLIC;
...
GRANT ALL ON TABLE public.property_meter_configs TO PUBLIC;
...
\unrestrict sH0cb40zo3DwslWBymlecwEUAWMXKtfGO56fVKbCwb7KIAvSkBNqzwFdZ9ZkVwN
