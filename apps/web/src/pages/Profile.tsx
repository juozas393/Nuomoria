...
const Profile: React.FC = () => {
  ...
  const fetchProfile = async () => {
    ...
    try {
      ...
      const p: ProfileData = { id: user.id, email: user.email, username: pd?.username || user.email?.split('@')[0] || 'user', first_name: fn, last_name: ln, phone: ud?.phone, role: user.role, avatar_url: pd?.avatar_url, created_at: ud?.created_at };
      setProfile(p);
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      setOriginalData(nfs); // isDirty auto-updates via useMemo
    ...
    <div className="min-h-screen relative">
      ...
      <div className="fixed inset-0 z-0 bg-gray-900">
        <div
          ...
          style={{
            backgroundImage: `url('/images/ProfileBackground_bw.png')`,
      ...
      {/* Compact Header Bar (fixed below global nav) */}
      <div className="fixed top-20 left-0 right-0 bg-white/90 backdrop-blur-md border-b border-gray-200 z-30">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="px-2 py-0.5 bg-[#2F8481]/10 text-[#2F8481] text-xs font-medium rounded-md">{getRoleName(profile.role)}</span>
                </div>
      ...
      {/* Spacer for fixed headers (global nav + save bar) */}
      <div className="h-36" />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            {/* Profile Photo Card */}
            <div className="backdrop-blur-md rounded-2xl border border-white/50 shadow-lg p-5" style={{ backgroundImage: "url('/images/FormsBackground.png')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="backdrop-blur-md rounded-2xl border border-white/50 shadow-lg p-5" style={{ backgroundImage: "url('/images/FormsBackground.png')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
              ...
              <div className="space-y-2.5 text-sm">
                <div className="flex justify-between"><span className="text-gray-500">Rolė</span><span className="font-medium text-gray-900">{getRoleName(profile.role)}</span></div>
