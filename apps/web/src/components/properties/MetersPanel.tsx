...
const meterMeta: Record<MeterType, { icon: React.ElementType; label: string }> = {
  water_cold: { icon: Droplets, label: "Šaltas vanduo" },
  water_hot: { icon: Droplets, label: "Karštas vanduo" },
  electricity: { icon: Zap, label: "Elektra" },
      ...
      <div className="flex items-center gap-3">
        <div className="relative">
          ...
          <input
            ...
            className="h-10 w-[280px] pl-10 pr-4 text-sm border border-neutral-300 rounded-xl focus:ring-2 focus:ring-[#2F8481] focus:border-[#2F8481] transition-colors duration-200 hover:border-neutral-400"
          />
        </div>
        <div className="flex rounded-xl border border-neutral-300 overflow-hidden shadow-sm">
          <button
            onClick={() => onFilterChange("all")}
            className={`px-4 py-2 text-sm font-medium transition-colors duration-200 ${filter === "all"
          ...
          <button
            ...
            className={`px-4 py-2 text-sm font-medium transition-colors duration-200 ${filter === "available"
              ? "bg-[#2F8481] text-white shadow-sm"
              : "bg-white text-neutral-600 hover:bg-neutral-50 hover:text-neutral-800"
              }`}
          >
...
function MeterRow({
        ...
        <div className="relative flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <button
              ...
              className={`p-1.5 rounded-md transition-colors duration-200 ${editValues.photoRequired ? 'bg-blue-100 text-blue-600' : 'bg-neutral-100 text-neutral-400'
                }`}
          ...
          <div className="flex items-center gap-1 flex-shrink-0">
            <button
              onClick={handleSave}
              className="p-1.5 rounded-md bg-green-100 text-green-600 hover:bg-green-200 transition-colors duration-200"
              title="Išsaugoti"
            >
  ...
  return (
    <div className="group relative overflow-hidden rounded-xl border border-neutral-200 bg-white p-3 hover:border-[#2F8481]/50 hover:shadow-lg transition-colors duration-300">
      ...
      <div className="relative flex items-center gap-3">
        ...
        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#2F8481]/10 to-[#2F8481]/20 flex items-center justify-center shadow-sm group-hover:shadow-md transition-shadow duration-300 flex-shrink-0">
          <Icon className="h-5 w-5 text-[#2F8481] transition-transform duration-300" />
        </div>
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <div className="flex items-center group/price">
            <input
              ...
              step="0.01"
              min="0"
              className="h-7 w-16 rounded-l-md border border-r-0 px-2 text-xs focus:ring-1 focus:ring-[#2F8481] focus:border-[#2F8481] transition-colors duration-200 group-hover/price:border-[#2F8481]/30"
          ...
          {meter.mode === "shared" && (
            ...
            >
              <option value="per_apartment">Butų sk.</option>
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`px-2 py-1 rounded-md text-xs font-medium transition-colors duration-200 ${meter.photoRequired
          ...
          <button
            ...
            className="p-1.5 rounded-md hover:bg-blue-50 transition-colors duration-200"
            title="Redaguoti"
          >
          ...
          <button
            ...
            className="p-1.5 rounded-md hover:bg-red-50 transition-colors duration-200"
            title="Pašalinti"
          >
...
function GroupHeader({ title, note, tone = "neutral" }: { title: string; note: string; tone?: "neutral" | "brand" }) {
  return (
    <div
      className={`mb-3 mt-6 rounded-lg border px-3 py-2 text-sm shadow-sm transition-colors duration-300 hover:shadow-md ${tone === "brand"
