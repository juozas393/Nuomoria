...
import logoImage from '../assets/LogoNormalSize-Photoroomsmaller.png';
...
const LoginPage: React.FC = () => {
  ...
  const handleGoogleLogin = useCallback(async () => {
    ...
    try {
      ...
      if (result.success) {
        clearAuthError();
        // Google OAuth will redirect, so we don't need to call redirectAfterLogin here
      } else {
        setGlobalError(result.error || 'Google prisijungimo klaida');
  ...
  }, [loginWithGoogle, clearAuthError]);
